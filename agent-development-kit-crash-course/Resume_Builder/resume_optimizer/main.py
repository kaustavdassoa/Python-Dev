...
# Ensure the parent directory is in sys.path so we can import resume_optimizer as a package
...
# Document Tools
from resume_optimizer.sub_agents.document_parser.tools import parse_pdf, parse_docx, parse_plain_text
...
async def optimize_resume(
    ...
    try:
        ...
        print(f"  File: {file.filename}  |  Time: {datetime.now().strftime('%H:%M:%S')}")
        print("=" * 70)
