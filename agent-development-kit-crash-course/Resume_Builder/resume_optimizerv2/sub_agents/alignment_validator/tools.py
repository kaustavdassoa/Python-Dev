...
def compare_seniority_levels(candidate_level: str, jd_level: str, jd_score_override: int = None) -> dict:
    """
    ...
    Args:
        ...
        jd_score_override: If provided, use this numerical score directly instead of inferring from jd_level.
    ...
    if jd_score_override is not None:
        j_score = jd_score_override
    else:
